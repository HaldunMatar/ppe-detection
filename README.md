> **Attribution:** This repository is a derivative copy of the original project
> [VoxDroid/Construction-Site-Safety-PPE-Detection](https://github.com/VoxDroid/Construction-Site-Safety-PPE-Detection),
> maintained here by [@HaldunMatar](https://github.com/HaldunMatar) for local deployment and experimentation.
> Original work © VoxDroid, released under the MIT License (see [LICENSE](LICENSE)).
> Local additions: `detect_video.py` (run detection on a video file) and small setup fixes documented below.
